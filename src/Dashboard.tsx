        ...
        <div className="flex flex-col md:flex-row p-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-lg">
            ...
            <div className="flex-grow p-4 md:ml-64">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2">
                    ...
                    <div className="md:col-span-2 bg-gray-700 p-4 rounded text-white flex flex-col md:flex-row gap-4">
                        {/* Component 1 */}
                        <div className="bg-gray-800 flex-1 p-4 rounded text-white flex items-center justify-center">
                            <Card />
                    ...
                    <div className="bg-gray-700 p-4 rounded text-white flex  md:row-span-2 md:col-span-1">
                        <Balance />
                    </div>

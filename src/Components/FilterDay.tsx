...
export const FilterDay: React.FC<FilterComponentProps> = ({ currentUser }) => {
  ...
  return (
    <>
      <div className='flex justify-evenly items-center p-4 rounded-lg shadow-lg text-white'>
        ...
        <div className="flex space-x-4">
          {(['Day', 'Week', 'Month', 'Year'] as TimeRange[]).map((range) => (
            <button
              ...
              className={`px-4 py-2 rounded-full ${selectedRange === range ? 'bg-orange-500 text-white' : 'bg-gray-700 text-gray-400'
